    ...
    <div className="relative bg-linear-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
      {recipe.imagePath ? (
        <>
          ...
          <div className="absolute inset-0 bg-linear-to-br from-black/70 via-black/50 to-black/60 z-10"></div>
          {/* Artistic overlay accents */}
          <div className="absolute inset-0 z-10 opacity-30">
            <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-linear-to-br from-orange-500/20 to-transparent blur-3xl"></div>
            <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-linear-to-tr from-green-500/20 to-transparent blur-3xl"></div>
          </div>
        </>
      ) : (
        <>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 py-20 md:py-32">
        <div className="max-w-3xl">
          <div
            className="inline-block bg-linear-to-r from-green-500 to-green-600 text-white px-5 py-2.5 rounded-full text-sm font-bold mb-6 shadow-lg animate-float"
            style={{
          ...
          <Link
            ...
            className="inline-block bg-linear-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-10 py-5 rounded-xl font-bold text-lg transition-all duration-300 shadow-2xl hover:shadow-green-500/50 hover:scale-105 animate-fade-in-up"
            style={{
              animationDelay: '0.6s',
